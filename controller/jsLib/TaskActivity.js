    	  ...
    	  return cname+" "+ tname +delimiter+assistantName +delimiter+experiItemName +delimiter+"(" +this.activities[index][0].adjustClone(this.endAtSat,validStart,false).marshal(from,startWeek,endWeek)+")";
    	   ...
    	   // marshal tempActivities
    	    for(var m=0;m<tempActivities.length;m++){
                ...
                if(courseName!==null) {marshalString+=delimiter+ courseName +" "+ teacherName;/* alert(courseName); */}
	...
	function TaskActivity(teacherId,teacherName,courseId,courseName,roomId,roomName,vaildWeeks,taskId,remark,assistantName,experiItemName,schGroupNo){
   	...
   	function cloneTaskActivity(){
   	    return new TaskActivity(this.teacherId,this.teacherName,this.courseId,this.courseName,this.roomId,this.roomName,this.vaildWeeks,this.taskId,this.remark,this.assistantName,this.experiItemName,this.schGroupNo);
   	}
   	// 
    ...
    function addActivityToCluster(teacherId,teacherName,roomId,roomName,weekIndex){
        ...
        if(null==this.weeksMap[teacherId+roomId]){
            ...
            this.activityMap[teacherId+roomId]=new TaskActivity(teacherId,teacherName,this.courseId,this.courseName,roomId,roomName,"",null,null,null,null,this.expGroupNo);
        }
